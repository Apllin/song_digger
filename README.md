...
- [python-service/](python-service/) — FastAPI service with adapters for Bandcamp, Beatport, Discogs, Spotify, YouTube Music, and Cosine Club
...
└── python-service/           FastAPI service
    ├── app/
    │   ├── adapters/         Bandcamp, Beatport, Discogs, Spotify, YT Music, Cosine Club
    │   ├── api/routes/
    │   └── core/
    ├── tests/
    ├── requirements.txt
